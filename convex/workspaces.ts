...
export const remove = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Delete all members, channels, conversations, messages and reactions associated with the workspace
    ...
    // Delete each member, channel, conversation, message, and reaction
